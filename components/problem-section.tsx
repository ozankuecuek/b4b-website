        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {problemCards.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative border border-border rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-card"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6">
                    <div className="w-14 h-14 rounded-xl flex items-center justify-center transition-colors duration-300 bg-primary/10 group-hover:bg-primary/20">
                      <Icon className="w-7 h-7 text-primary" />
                    </div>
                  </div>
                  
                  {/* Content */}
                  <h3 className="text-xl font-semibold mb-4 leading-tight text-foreground">
                    {card.title}
                  </h3>
